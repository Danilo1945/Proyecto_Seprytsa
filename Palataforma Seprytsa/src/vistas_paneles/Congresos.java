 ...
 * @author Danilo
 */
public class Congresos extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img_menu/congresos_52px.png"))); // NOI18N
        jLabel1.setText("      Congresos");
        ...
        txt_nombre.setPlaceholder("Nombre del Congreso:");
        ...
        txt_Dur_sem.setPlaceholder("Duración del Congreso:");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(cbox_Umedi_dur_cur, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)))
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
...
//           }
            ...
            try {
                ...
                pst = cn.prepareStatement("INSERT INTO `congresos`(`codigo_con`, `Nombre_con`, `duracion_con`) VALUES (?,?,?)");
...
//Buscar Por.., Código, Nombre, Apellido
    ...
    private void btn_actualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_actualizarActionPerformed
        ...
        try {
            ...
            PreparedStatement pst = cn.prepareStatement("UPDATE `congresos` SET `Nombre_con`=?,`duracion_con`=? WHERE congresos.codigo_con='" + codigo + "'");
...
//        wa.setVisible(true);
            ...
            if (res == 1) {
                ...
                String codigo = txt_codigo.getText().toString();
                PreparedStatement pst;
                pst = cn.prepareStatement("DELETE FROM `congresos` WHERE congresos.codigo_con=?");
                pst.setString(1, codigo);
                pst.executeUpdate();
...
//Buscar Por.., Código, Nombre, Apellido
    ...
    public void consutarTabla_Seminario() {
        ...
        String consultaBD = "SELECT * FROM `congresos`";
    ...
    public void consutaBD(String Campo, String txtSQL) {
        ...
        //String consultaBD = "SELECT * FROM `docente` WHERE " + Campo + "='" + txtSQL + "'";
          String consultaBD = "SELECT * FROM `congresos` WHERE " + Campo + " LIKE '" + txtSQL + "_%'";
     ...
     public void consutaBD_sinfiltros(String Campo, String txtSQL) {
        ...
        String consultaBD = "SELECT * FROM `congresos` WHERE " + Campo + "='" + txtSQL + "'";
