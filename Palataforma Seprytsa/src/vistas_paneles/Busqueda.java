...
public class Busqueda extends javax.swing.JFrame {
   ...
   Datos d= new Datos();
    ...
    private void initComponents() {
        ...
        btn_guardar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img_alertas/Img_sub_menus/icons8_Hand_Cursor_52px.png"))); // NOI18N
...
//JOptionPane.showMessageDialog(null, Entidad);
        ...
        if (Entidad == "estudiante") {
            ...
            Main.p.ins.txt_cod_estudiante_cur.setText(Lectura);
            Main.p.ins.txt_cod_estudiante_sem.setText(Lectura);
            Main.p.ins.txt_cod_estudiante_con.setText(Lectura);
            Main.p.ins.txt_cod_estudiante_lic.setText(Lectura);
        }
        if (Entidad == "periodo_academico") {
        ...
        if (Entidad == "cursos") {
            Main.p.ins.txt_cod_Curso.setText(Lectura);
        }
        if (Entidad == "seminarios") {
            Main.p.ins.txt_cod_sem.setText(Lectura);
        }
         if (Entidad == "congresos") {
            Main.p.ins.txt_cod_con.setText(Lectura);
        }
          if (Entidad == "licencias") {
            Main.p.ins.txt_cod_lic.setText(Lectura);
        }
