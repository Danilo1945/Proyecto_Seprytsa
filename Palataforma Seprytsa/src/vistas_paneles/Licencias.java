...
public class Licencias extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img_menu/licencias_52px.png"))); // NOI18N
        ...
        cbox_buscar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Buscar Por..", "Código", "Nombre", "Año" }));
        ...
        txt_nombre.setPlaceholder("Nombre del la Licencia:");
        ...
        cbox_Umedi_dur_cur.setBackground(new java.awt.Color(21, 96, 136));
        ...
        txt_Dur_sem.setPlaceholder("Duración de la Licencia:");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txt_Dur_sem, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(cbox_Umedi_dur_cur, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
...
//           }
            ...
            try {
                ...
                pst = cn.prepareStatement("INSERT INTO `licencias`(`cod_lic`, `Nombre_lic`, `año_lic`, `duracion_lic`) VALUES (?,?,?,?)");

                pst.setString(1, codigo);
                pst.setString(2, nombre);
                 pst.setInt(3, anio);
                pst.setString(4  ,dur_cur +"/"+ U_m_dur_sem);
...
//Buscar Por.., Código, Nombre, Apellido
    ...
    private void btn_actualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_actualizarActionPerformed
        ...
        try {
            ...
            PreparedStatement pst = cn.prepareStatement("UPDATE `licencias` SET `Nombre_lic`=?,`año_lic`=?,`duracion_lic`=? WHERE licencias.cod_lic='" + codigo + "'");
...
//        wa.setVisible(true);
            ...
            if (res == 1) {
                ...
                String codigo = txt_codigo.getText().toString();
                PreparedStatement pst;
                pst = cn.prepareStatement("DELETE FROM `licencias` WHERE licencias.cod_lic=?");
                pst.setString(1, codigo);
                pst.executeUpdate();
    ...
    private void Tabla_cursosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Tabla_cursosMouseClicked
        try {
            ...
            if (fila > -1) {
                ...
                String seleccion1 = separar2(String.valueOf(Tabla_cursos.getValueAt(fila, 3).toString()),0);
                String seleccion2=separar2(String.valueOf(Tabla_cursos.getValueAt(fila, 3).toString()),1);
                txt_Dur_sem.setText(seleccion1);
                year.setYear(Integer.parseInt(Tabla_cursos.getValueAt(fila, 2).toString()));
                switch (seleccion2) {
...
//Buscar Por.., Código, Nombre, Apellido
    ...
    public void consutarTabla_Seminario() {
        ...
        String consultaBD = "SELECT * FROM `licencias`";
    ...
    public void consutaBD(String Campo, String txtSQL) {
        ...
        //String consultaBD = "SELECT * FROM `docente` WHERE " + Campo + "='" + txtSQL + "'";
          String consultaBD = "SELECT * FROM `licencias` WHERE " + Campo + " LIKE '" + txtSQL + "_%'";
     ...
     public void consutaBD_sinfiltros(String Campo, String txtSQL) {
        ...
        String consultaBD = "SELECT * FROM `licencias` WHERE " + Campo + "='" + txtSQL + "'";
