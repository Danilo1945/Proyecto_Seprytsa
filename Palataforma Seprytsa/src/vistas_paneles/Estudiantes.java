...
public class Estudiantes extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        Tabla_estudiantes = new rojerusan.RSTableMetro();
        ...
        cbox_tipo_sangre = new rojerusan.RSComboMetro();
        ...
        Tabla_estudiantes.setColorBackgoundHead(new java.awt.Color(21, 96, 136));
        Tabla_estudiantes.setColorBordeFilas(new java.awt.Color(255, 255, 255));
        Tabla_estudiantes.setColorBordeHead(new java.awt.Color(21, 96, 136));
        Tabla_estudiantes.setColorFilasBackgound2(new java.awt.Color(255, 255, 255));
        Tabla_estudiantes.setColorFilasForeground1(new java.awt.Color(21, 96, 136));
        Tabla_estudiantes.setColorFilasForeground2(new java.awt.Color(21, 96, 136));
        Tabla_estudiantes.setColorSelBackgound(new java.awt.Color(27, 108, 155));
        Tabla_estudiantes.setGridColor(new java.awt.Color(255, 255, 255));
        Tabla_estudiantes.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                Tabla_estudiantesMouseClicked(evt);
            }
        });
        docente_menu.setViewportView(Tabla_estudiantes);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img_menu/Estudiantes__52px.png"))); // NOI18N
        ...
        cbox_tipo_sangre.setBackground(new java.awt.Color(21, 96, 136));
        cbox_tipo_sangre.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tipo de sangre", "A +", "A -", "B +", "B -", "O +", "O -", "AB +", "AB -" }));
        cbox_tipo_sangre.setActionCommand("comboBoxChanged\nd\nd\nd\nd\nd");
        cbox_tipo_sangre.setColorArrow(new java.awt.Color(21, 96, 136));
        cbox_tipo_sangre.setColorBorde(new java.awt.Color(27, 108, 155));
        cbox_tipo_sangre.setColorFondo(new java.awt.Color(21, 96, 136));
        cbox_tipo_sangre.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        cbox_tipo_sangre.setName(""); // NOI18N
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                            ...
                            .addGap(18, 18, 18)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(cbox_tipo_sangre, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)))
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(cbox_tipo_sangre, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        try {
            ...
            String tipo_sangre= cbox_tipo_sangre.getSelectedItem().toString();
...
//           }
            ...
            try {
                ...
                pst = cn.prepareStatement("INSERT INTO `estudiante`(`cod_est`, `Nombre_est`, `Apellido_est`, `Direccion_est`, `telefono_est`, `fecha_nacimiento_est`, `nacionalidad_est`, `tipo_sangre_est`) VALUES (?,?,?,?,?,?,?,?)");
...
//Buscar Por.., Código, Nombre, Apellido
    ...
    private void btn_actualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_actualizarActionPerformed
        ...
        try {
            ...
            PreparedStatement pst = cn.prepareStatement("UPDATE `estudiante` SET `Nombre_est`=?,`Apellido_est`=?,`Direccion_est`=?,`telefono_est`=?,`fecha_nacimiento_est`=?,`nacionalidad_est`=?,`tipo_sangre_est`=?  WHERE  estudiante.cod_est='" + codigo + "'");
...
//        wa.setVisible(true);
            ...
            if (res == 1) {
                ...
                String codigo = txt_codigo.getText().toString();
                PreparedStatement pst;
                pst = cn.prepareStatement("DELETE FROM `estudiante` WHERE estudiante.cod_est=?");
                pst.setString(1, codigo);
                pst.executeUpdate();
    ...
    private void Tabla_estudiantesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Tabla_estudiantesMouseClicked
        try {
            ...
            if (fila > -1) {
                ...
                txt_codigo.setText(Tabla_estudiantes.getValueAt(fila, 0).toString());
                txt_nombre.setText(Tabla_estudiantes.getValueAt(fila, 1).toString());
                txt_apellido.setText(Tabla_estudiantes.getValueAt(fila, 2).toString());
                txt_direccion.setText(Tabla_estudiantes.getValueAt(fila, 3).toString());
                txt_telefono.setText(Tabla_estudiantes.getValueAt(fila, 4).toString());
                String strFecha = Tabla_estudiantes.getValueAt(fila, 5).toString();
                ...
                switch (seleccion) {
                 ...
                 String seleccion2=String.valueOf(Tabla_estudiantes.getValueAt(fila, 7).toString());
                
                switch (seleccion2) {

                    case "A +":

                        cbox_tipo_sangre.setSelectedIndex(1);

                        break;

                    case "A -":

                        cbox_tipo_sangre.setSelectedIndex(2);

                        break;
                    case "B +":
 //Tipo de sangre, A +, A -, B +, B -, O +, O -, AB +, AB -
                        cbox_tipo_sangre.setSelectedIndex(3);

                        break;

                    case "B -":

                        cbox_tipo_sangre.setSelectedIndex(4);

                        break;
                        case "O +":

                        cbox_tipo_sangre.setSelectedIndex(5);

                        break;
                        case "O -":

                        cbox_tipo_sangre.setSelectedIndex(6);

                        break;
                        case "AB +":

                        cbox_tipo_sangre.setSelectedIndex(7);

                        break;
                        case "AB -":

                        cbox_tipo_sangre.setSelectedIndex(8);
...
//Buscar Por.., Código, Nombre, Apellido
    ...
    public void consutarTabla_Estudiantes() {
        ...
        String consultaBD = "SELECT * FROM `estudiante`";
        javax.swing.JTable Tabla = this.Tabla_estudiantes;
    ...
    private void vaciar_cajas() {
        ...
        cbox_nacionalidad.setEnabled(false);
         cbox_tipo_sangre.setEnabled(false);
    ...
    private void nuevo(){
        ...
        cbox_tipo_sangre.setEnabled(true);
    ...
    private rojerusan.RSTableMetro Tabla_estudiantes;
    ...
    private rojerusan.RSComboMetro cbox_tipo_sangre;
