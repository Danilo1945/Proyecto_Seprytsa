 ...
 * @author Danilo
 */
public class Menu_RMatriculas extends javax.swing.JDialog {
     ...
     */
    public Menu_RMatriculas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        btn_producto2.setText(" Por Filtros             ");
...
Reportes rp= new Reportes();
	...
	private void btn_producto2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_producto2ActionPerformed
            // TODO add your handling code here:
             Main.p.pintar(16);
        Matriculas_reportes RM = new Matriculas_reportes();
        new cambia_panel(Main.p.panel_master, RM);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Menu_RMatriculas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Menu_RMatriculas dialog = new Menu_RMatriculas(new javax.swing.JFrame(), true);
