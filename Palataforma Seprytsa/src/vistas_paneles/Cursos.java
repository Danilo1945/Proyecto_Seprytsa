...
public class Cursos extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cbox_tipo_cur = new rojerusan.RSComboMetro();
        ...
        txt_Dur_cur = new rojerusan.RSMetroTextPlaceHolder();
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img_menu/cursos_52px.png"))); // NOI18N
        ...
        cbox_buscar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Buscar Por..", "Código", "Nombre", "Tipo Curso" }));
        ...
        cbox_tipo_cur.setBackground(new java.awt.Color(51, 51, 255));
        cbox_tipo_cur.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tipo de Curso:", "SETEC", "ESIPEC", " " }));
        cbox_tipo_cur.setActionCommand("comboBoxChanged\nd\nd\nd\nd\nd");
        cbox_tipo_cur.setColorArrow(new java.awt.Color(21, 96, 136));
        cbox_tipo_cur.setColorBorde(new java.awt.Color(27, 108, 155));
        cbox_tipo_cur.setColorFondo(new java.awt.Color(21, 96, 136));
        cbox_tipo_cur.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        cbox_tipo_cur.setName(""); // NOI18N
        ...
        txt_Dur_cur.setForeground(new java.awt.Color(27, 108, 155));
        txt_Dur_cur.setBorderColor(new java.awt.Color(21, 96, 136));
        txt_Dur_cur.setBotonColor(new java.awt.Color(21, 96, 136));
        txt_Dur_cur.setCaretColor(new java.awt.Color(21, 96, 136));
        txt_Dur_cur.setDisabledTextColor(new java.awt.Color(102, 102, 255));
        txt_Dur_cur.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        txt_Dur_cur.setPhColor(new java.awt.Color(27, 108, 155));
        txt_Dur_cur.setPlaceholder("Duración de Curso:");
        txt_Dur_cur.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_Dur_curActionPerformed(evt);
            }
        });
        txt_Dur_cur.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txt_Dur_curKeyTyped(evt);
            }
        });
                    ...
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addComponent(cbox_tipo_cur, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(txt_Dur_cur, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)))
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(4, 4, 4)
                        .addComponent(txt_Dur_cur, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(cbox_tipo_cur, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(43, 43, 43)
                        .addComponent(btn_guardar, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap())))
        );

        cbox_tipo_cur.getAccessibleContext().setAccessibleName("");
        cbox_tipo_cur.getAccessibleContext().setAccessibleDescription("");
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        try {
            ...
            String dur_cur=txt_Dur_cur.getText().toString();
            String U_m_dur_cur=cbox_Umedi_dur_cur.getSelectedItem().toString();
            String tipo_cur = cbox_tipo_cur.getSelectedItem().toString();
...
//           }
            ...
            try {
                ...
                pst = cn.prepareStatement("INSERT INTO `cursos`(`codigo_cur`, `Nombre_cur`, `duracion_cur`, `tipo_cur`) VALUES (?,?,?,?)");

                pst.setString(1, codigo);
                pst.setString(2, nombre);
                pst.setString(3  ,dur_cur +"/"+ U_m_dur_cur);
                pst.setString(4  ,tipo_cur);
...
//Buscar Por.., Código, Nombre, Apellido
    ...
    private void btn_actualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_actualizarActionPerformed
        ...
        try {
            ...
            PreparedStatement pst = cn.prepareStatement("UPDATE `cursos` SET `Nombre_cur`=?,`duracion_cur`=?,`tipo_cur`=? WHERE cursos.`codigo_cur`='" + codigo + "'");

                pst.setString(1  , nombre);
                pst.setString(2  ,dur_cur +"/"+ U_m_dur_cur);
                pst.setString(3  ,tipo_cur);
    ...
    private void Tabla_cursosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Tabla_cursosMouseClicked
        try {
            ...
            if (fila > -1) {
                ...
                txt_Dur_cur.setText(seleccion1);
                switch (seleccion2) {
                ...
                String seleccion3 = String.valueOf(Tabla_cursos.getValueAt(fila, 3).toString());
                
                 switch (seleccion3) {
                     case "SETEC":

                        cbox_tipo_cur.setSelectedIndex(1);

                        break;
                        case "ESIPEC":

                        cbox_tipo_cur.setSelectedIndex(2);
...
//Buscar Por.., Código, Nombre, Apellido
    ...
    private void txt_Dur_curActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_Dur_curActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_Dur_curActionPerformed

    private void txt_Dur_curKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_Dur_curKeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_Dur_curKeyTyped

    public void consutarTabla_Diplomados() {

        String consultaBD = "SELECT * FROM `cursos`";
    ...
    public void consutaBD(String Campo, String txtSQL) {
        ...
        //String consultaBD = "SELECT * FROM `docente` WHERE " + Campo + "='" + txtSQL + "'";
          String consultaBD = "SELECT * FROM `cursos` WHERE " + Campo + " LIKE '" + txtSQL + "_%'";
     ...
     public void consutaBD_sinfiltros(String Campo, String txtSQL) {
        ...
        String consultaBD = "SELECT * FROM `cursos` WHERE " + Campo + "='" + txtSQL + "'";
    ...
    private void vaciar_cajas() {
        ...
        cbox_tipo_cur.setSelectedIndex(0);
        ...
        cbox_tipo_cur.setEnabled(false);
        
        txt_codigo.setEnabled(false);
        Tabla_cursos.setEnabled(false);
        txt_buscar.setEnabled(false);
         txt_Dur_cur.setEnabled(false);
    ...
    private rojerusan.RSComboMetro cbox_tipo_cur;
    private javax.swing.JScrollPane docente_menu;
    private javax.swing.JLabel jLabel1;
    private javax.swing.JPanel jPanel1;
    private javax.swing.JPanel jPanel2;
    private rojerusan.RSMetroTextPlaceHolder txt_Dur_cur;
